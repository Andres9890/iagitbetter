...
def mock_upload_response_by_identifier(m, identifier, files):
    ...
    for filepath in files:
        ...
        m.put(f'https://s3.us.archive.org/{identifier}/{filename}',
              content=b'',
...
class GitArchiverTests(unittest.TestCase):
    ...
    def test_fetch_api_metadata_github(self, m):
        ...
        m.get('https://api.github.com/repos/testuser/testrepo',
              json=github_api_response)
        
        self.archiver._fetch_api_metadata()
        
        self.assertEqual(self.archiver.repo_data['description'], 
                        'Test repository for iagitbetter')
    ...
    def test_fetch_api_metadata_gitlab(self, m):
        ...
        m.get('https://gitlab.com/api/v4/projects/testgroup%2Ftestproject',
    ...
    def test_clone_repository_with_specific_branch(self):
        ...
        repo_path = self.archiver.clone_repository(
            repo_url, specific_branch='develop')
...
"""
    ...
    def test_download_avatar(self, m):
        ...
        m.get('https://avatars.githubusercontent.com/u/12345',
    ...
    def test_fetch_releases_github(self, m):
        ...
        m.get('https://api.github.com/repos/testuser/testrepo/releases',
